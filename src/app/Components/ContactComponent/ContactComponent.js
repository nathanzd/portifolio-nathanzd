...
export const ContactComponent = () => {
  return (
    <div className={`${styles.ContactComponentForm}`} style={{display:'flex',alignItems:'center',justifyContent:'space-around'}}>

        <div className={`${styles.TextPreForm}`}>
            <div  className={`${styles.TextPreFormText}`} >
                <center><h1  style={{color:'white',fontSize:25,fontWeight:'bold'}}>{ i18next.t('contact.title')}</h1></center>
                <p style={{color:'white',textAlign:'center'}}> { i18next.t('contact.description')}
                
                </p>
                <div style={{display:'flex',gap:15,alignItems:'center',justifyContent:'center'}}>
                    <p className={`${styles.contactText}`} style={{color:'white',fontWeight:'bold'}}>+55 11 913487423</p>
                    <p className={`${styles.contactText}`} style={{color:'white',fontWeight:'bold'}}>nathan.fe.dias@gmail.com</p>
                </div>
            </div>
        ...
        <div id='contact' className={`${styles.ContactFormWrapper}`}>
            <form className={styles.ContactForm} action="https://api.staticforms.xyz/submit" method="post">
                ...
                <input className={styles.ContactInput} type="hidden" name="accessKey" value="bdeb36f9-35ed-4784-9240-14b75a0b9c62"/> 
                <input className={styles.ContactInput} type="text" name="name" placeholder={ i18next.t('contact.contactForm.name')}/> 
                <input className={styles.ContactInput} type="text" name="email" placeholder={ i18next.t('contact.contactForm.email')}/> 
                <input className={styles.ContactInput} type="text" name="phone" placeholder={ i18next.t('contact.contactForm.phone')}/> 
                <input type="hidden" name="subject" value="Contact from portifolio" />
                <input  className={styles.ContactInput} type="text" name="subject" placeholder={ i18next.t('contact.contactForm.subject')}/>
                <textarea className={styles.ContactTextArea} rows="5" name="message" placeholder={ i18next.t('contact.contactForm.message')}></textarea> 
                
                
                {/*<input type="hidden" name="redirectTo" value="https://datahash.com.br/contato"/> */}
                <input className={styles.ContactFormSubmit} type="submit" value={ i18next.t('contact.contactForm.submit')} />
            </form>
        </div>
